...
<html>
<head>
    <title>Edit Movie - CinemaScope</title>
...
<main class="main-content">
    ...
    <div class="form-card">
        <form method="post" action="/movies/edit/${fn:escapeXml(movie.id)}" enctype="multipart/form-data">
            <div class="form-group">
                <label for="title">Title:</label>
                <input type="text" id="title" name="title" class="form-control" value="${fn:escapeXml(movie.title)}" required>
            </div>
            <div class="form-group">
                ...
                <select id="categoryId" name="categoryId" class="form-control" required>
                    ...
                    <c:forEach var="category" items="${categories}">
                        <option value="${category.id}" <c:if test="${category.id == movie.categoryId}">selected</c:if>>${fn:escapeXml(category.name)}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="form-group">
                <label for="year">Year:</label>
                <input type="number" id="year" name="year" class="form-control" value="${movie.year}" placeholder="Enter release year" required>
            </div>
            <div class="form-group">
                <label for="price">Price:</label>
                <input type="number" step="0.01" id="price" name="price" class="form-control" value="${movie.price}" placeholder="Enter price" required>
            </div>
            <div class="form-group">
                <label for="totalCopies">Available Copies:</label>
                <input type="number" id="totalCopies" name="totalCopies" class="form-control" min="1" value="${movie.totalCopies}" required>
            </div>
            <div class="form-group">
                <label for="thumbnail">Thumbnail Image (Optional):</label>
                <input type="file" id="thumbnail" name="thumbnail" class="form-control" accept="image/*">
                <c:if test="${not empty movie.thumbnailPath}">
                    <p>Current Thumbnail:</p>
                    <img src="/images/${fn:escapeXml(movie.thumbnailPath)}" alt="Current Thumbnail" class="thumbnail-preview">
                </c:if>
            </div>
