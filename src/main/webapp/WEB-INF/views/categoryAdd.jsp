...
<html>
<head>
    <title>Add Category - CinemaScope</title>
...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <c:if test="${user.role == 'ADMIN'}">
            ...
            <li>
                <a class="nav-link admin-link active" href="/categories"><i class="fas fa-tags"></i> Categories</a>
            </li>
            <li>
...
<main class="main-content">
    <div class="page-header">
        ...
        <p>Create a new category for organizing movies</p>
    </div>
