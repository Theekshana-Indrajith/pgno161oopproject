...
<html>
<head>
    <title>Add Review - CinemaScope</title>
...
<main class="main-content">
    ...
    <c:if test="${not empty movie}">
        ...
        <div class="form-card">
            <form:form modelAttribute="review" method="post" action="/review/add/${movie.id}">
                <form:hidden path="username"/>
                <form:hidden path="movieId"/>
                <div class="form-group">
                    <label for="rating">Rating (1-5):</label>
                    <form:input path="rating" id="rating" type="number" min="1" max="5" step="0.1" class="form-control" required="true"/>
                </div>
                <div class="form-group">
                    <label for="comment">Comment:</label>
                    <form:textarea path="comment" id="comment" class="form-control" rows="5"/>
                </div>
