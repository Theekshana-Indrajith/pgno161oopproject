...
<html>
<head>
    <title>Recently Watched - CinemaScope</title>
    ...
    <style>
        * {
        ...
        body {
            ...
            url('https://images.unsplash.com/photo-1570385404967-fe4e1b48454b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')
        ...
        .recently-watched li i {
            color: #00d4ff;
            font-size: 1.3rem;
        }

        .recently-watched li a {
            color: #fff;
            text-decoration: none;
            font-weight: 500;
...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li>
            <a class="nav-link active" href="/recently-watched"><i class="fas fa-history"></i> Recently Watched</a>
        </li>
...
<main class="main-content">
    <div class="page-header">
        ...
        <p>View the movies you've recently watched</p>
    </div>

    <div class="recently-watched">
        <c:if test="${empty recentlyWatched}">
            <div class="empty-state">
                <p>You haven't watched any movies recently.</p>
            </div>
        </c:if>
        <c:if test="${not empty recentlyWatched}">
            <ul>
                <c:forEach var="movieId" items="${recentlyWatched}">
                    <li>
                        <i class="fas fa-film"></i>
                        <a href="/movies/view/${movieId}">${fn:escapeXml(movieTitles[movieId])}</a>
                    </li>
                </c:forEach>
            </ul>
        </c:if>
