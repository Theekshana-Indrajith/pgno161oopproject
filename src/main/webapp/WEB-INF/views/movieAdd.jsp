...
<html>
<head>
    <title>Add Movie - CinemaScope</title>
...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <c:if test="${user.role == 'ADMIN'}">
            ...
            <li>
                <a class="nav-link active admin-link" href="/movies/add"><i class="fas fa-plus-circle"></i> Add New Movie</a>
            </li>
            <li>
...
<main class="main-content">
    <div class="page-header">
        <h1>Add New Movie</h1>
        <p>Fill in the details to add a new movie to the collection</p>
    </div>
    ...
    <div class="form-card">
        <form method="post" action="/movies/add" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" id="year" name="year" class="form-control" placeholder="Enter release year" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="totalCopies" name="totalCopies" class="form-control" min="1" value="1" required>
            </div>
            <div class="form-group">
            ...
            <div class="d-flex gap-2 justify-content-center flex-wrap">
                <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to add this movie? Title: ' + document.getElementById('title').value);">Add Movie</button>
