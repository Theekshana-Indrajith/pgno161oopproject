...
<html>
<head>
    <title>Edit Profile - CinemaScope</title>
    ...
    <div class="form-card">
        <form method="post" action="/profile/edit">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" value="${fn:escapeXml(user.name)}" required>
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" class="form-control" value="${fn:escapeXml(user.email)}" required>
            </div>
