...
<html>
<head>
    <title>Category Manag ment - CinemaScope</title>
...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <c:if test="${user.role == 'ADMIN'}">
            ...
            <li>
                <a class="nav-link active admin-link" href="/categories"><i class="fas fa-tags"></i> Categories</a>
            </li>
...
<main class="main-content">
    <div class="page-header">
        ...
        <p>Add, edit, or delete movie categories</p>
    </div>

    <div class="action-buttons">
        <a href="/categories/add" class="btn btn-primary">Add New Category</a>
    </div>
                ...
                <c:forEach var="category" items="${categories}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/categories/delete/${category.id}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete ${fn:escapeXml(category.name)}?');">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<footer>
    <div class="container text-center">
        ...
        <p>©️ 2025 CinemaScope. All rights reserved.</p>
    </div>
</footer>
